...
H.CreateArraySummonSkill = function(spec)
  ...
  skill.canUse = function(curSkill, player, card)
    return curSkill:isEffectable(player) -- and 
  end
...
--- 阵法技
---@class BattleArraySkill : TriggerSkill
H.BattleArraySkill = TriggerSkill:subclass("BattleArraySkill")

local function readTriggerSpecToSkill(skill, spec)
  readUsableSpecToSkill(skill, spec)
...
---@class TriggerSkillSpec: TriggerSkill

---@class BattleArraySkill: TriggerSkillSpec

---@param spec BattleArraySkillSpec
---@return BattleArraySkill
H.CreateBattleArraySkill = function(spec)
  assert(type(spec.name) == "string")
  assert(type(spec.array_type) == "string")

  local skill = H.BattleArraySkill:new(spec.name)
  readTriggerSpecToSkill(skill, spec)

  skill.main_skill = H.ArraySummonSkill:new(spec.name) -- ?
  skill.arrayType = spec.array_type
