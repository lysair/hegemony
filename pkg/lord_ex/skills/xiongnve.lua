...
xiongnve:addEffect(fk.EventPhaseStart,{
    ...
    room:notifySkillInvoked(player, xiongnve.name, event:getCostData(self).choice == "xiongnve_choice2" and "control" or "offensive")
    ...
    room:setPlayerMark(player, "@xiongnve_choice-phase", "xiongnve_effect" .. string.sub(event:getCostData(self).choice, 16, 16))
