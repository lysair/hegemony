...
tongdu:addEffect(fk.EventPhaseStart,{
    ...
    can_trigger = function (self, event, target, player, data)
        ...
        or (target ~= player and not player:hasShownSkill(tongdu.name)) then return false end
    ...
    on_cost = function(self, event, target, player, data)
      return target.room:askToSkillInvoke(target, {skill_name = tongdu.name, prompt =  "#ld__tongdu-ask:" .. player.id .. "::" .. event:getCostData(self).n})
    end,
